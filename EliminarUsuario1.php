    ...
    <div class="container"  >
        ...
        <div class="row " >
            ...
            <div class="col-sm-8 ">
                    ...
                    <form  action="EliminarUsuario2.php" method="POST"  onsubmit="return validar();">
                        <fieldset id="fieldset" disabled>
                            ...
                            <input type="number" value="<?php echo $row[2];?>"  class="form-control form-control-sm"  id="Documento" name="Documento" required>     
                        ...
                        <div class="row">
                                <div class="col">
                                    <button class="boton1" type="submit"id="Guardar" onclick="return ConfirmEliminar()">Eliminar</button>
                                </div>
                                <div class="col">
