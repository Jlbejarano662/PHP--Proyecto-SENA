...
<body >
    ...
    <div class="container"  >
        ...
        <div class="row " >
               ...
               <div class="col-sm-8">
                    <br>
                    <h4 class=" texto3 " >Eliminar usuario</h4>
                    ...
                    ?>
                                   ...
                                   <div class="alert alert-success">
                                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                                        <strong class>¡éxito!</strong> El usuario fue eliminado.
                                   </div>
                    <?php
                            }
                            if($_GET['error']==3)
                    ...
                    ?>
                                   ...
                                   <div class="alert alert-danger ">
                                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                                        <strong>¡Error!</strong> El usuario no fue eliminado.
                                   </div>
                    <?php
                              }
                         }
                    ...
                    <form  action="BuscarUsuario.php" method="POST" onsubmit="return Busqueda();">
                        ...
                        <div class="row" >
                            ...
                            <div class="col">
                                <center>
                                    <button class="boton5" type="submit" value="BotonEliminarUsuario" id="BotonBuscar" name="BotonBuscar">buscar</button><br>
                                </center>
                            </div>
                        </div>
                    </form>
                    ...
                    <form  action="#" method="POST"  onsubmit="return validar();">
                        ...
                        <div class="row">
                                <div class="col">
                                    <button class="boton1 disabled" type="submit"id="Guardar" disabled onclick="return ConfirmGuardar1()">Eliminar</button>
                                </div>
                                <div class="col">
